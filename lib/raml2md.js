...
function _addSpacesBeforeLine(paragraph, spaces) {
...
function _formatQueryParameters(query) {
    if (typeof query == 'undefined')
        return;
    console.log(query);
}
function _extractLanguageFromMime(mime) {
...
function getDefaultConfig(mainTemplate, resourceTemplate) {
    ...
    return {
        ...
        helpers: {
            ...
            extractLanguageFromMime: _extractLanguageFromMime
        },
        partials: {
